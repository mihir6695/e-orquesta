			...
			<div class="span12">
	      		...
	      		<div id="horizontal" class="widget widget-form">
					...
					<div class="widget-content">
						...
						<form class="form-horizontal" method="post" action="index.php?page=gallery_action" enctype="multipart/form-data" onsubmit="return gallery_form();">
					        <fieldset>
                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>" />
                             ...
                             <div class="control-group">
					            ...
					            <div class="controls">					              
					              <input type="file" class="input-large" name="video" ><?php echo $row['video'];?>
					             </div>
					          </div>							  
